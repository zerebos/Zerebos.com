...
export default {
    ...
    sections: [
        ...
        {
            title: "Current",
            content: `I work at IBM as a firmware engineer for the System Z mainframes. I specifically work in the recovery area, so when something goes wrong, my code kicks in to try and fix things and get them back to a working state. Outside of that, I work on <a href="https://betterdiscord.app/" target="_blank" rel="noopener noreferrer">BetterDiscord</a> and the ecosystem around it. I run a <a href="https://discord.com/servers/49ers-322620751817736192" target="_blank" rel="noopener noreferrer">Discord server</a> for the San Francisco 49ers. I <a href="${links.icons.find(l => l.icon === "twitter").href}" target="_blank" rel="noopener noreferrer">tweet</a>. I play <a href="${links.categories.find(l => l.label.includes("Other")).links.find(l => l.label.toLowerCase() === "steam").href}" target="_blank" rel="noopener noreferrer">video games</a>. And occasionally, I work on other small side projects that get put up on <a href="${links.icons.find(l => l.icon === "github").href}" target="_blank" rel="noopener noreferrer">GitHub</a>. Other than that, I don't do too much under this pseudonym just yet.`
        },
        {
            title: "Future",
